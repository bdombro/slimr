/**
 * This file is identical to the preact version (/packages/styled-preact/src/index.tsx) except for
...
export const tags = {
   ...
   * @param templateString css - to be transpiled and injected
   */
  button: (...props: TempSProps) => styled('button' as unk as P2C<Prims['button']>)(...props),
  /**
   * Creates an div tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  div: (...props: TempSProps) => styled('div' as unk as P2C<Prims['div']>)(...props),
  /**
   * Creates an img tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  img: (...props: TempSProps) => styled('img' as unk as P2C<Prims['img']>)(...props),
  /**
   * Creates an form tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  form: (...props: TempSProps) => styled('form' as unk as P2C<Prims['form']>)(...props),
  /**
   * Creates an input tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  input: (...props: TempSProps) => styled('input' as unk as P2C<Prims['input']>)(...props),
  /**
   * Creates an label tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  label: (...props: TempSProps) => styled('label' as unk as P2C<Prims['label']>)(...props),
  /**
   * Creates an nav tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  nav: (...props: TempSProps) => styled('nav' as unk as P2C<Prims['nav']>)(...props),
  /**
   ...
   * @param templateString css - to be transpiled and injected
   */
  pre: (...props: TempSProps) => styled('pre' as unk as P2C<Prims['pre']>)(...props),
  /**
   * Creates an span tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  span: (...props: TempSProps) => styled('span' as unk as P2C<Prims['span']>)(...props),
  /**
   * Creates an table tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  table: (...props: TempSProps) => styled('table' as unk as P2C<Prims['table']>)(...props),
  /**
   * Creates an td tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  td: (...props: TempSProps) => styled('td' as unk as P2C<Prims['td']>)(...props),
  /**
   * Creates an tr tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  tr: (...props: TempSProps) => styled('tr' as unk as P2C<Prims['tr']>)(...props),
  /**
   * Creates an textarea tag with css styles
   * @param templateString css - to be transpiled and injected
   */
  textarea: (...props: TempSProps) => styled('textarea' as unk as P2C<Prims['textarea']>)(...props),
}
...
type P2C<T extends PrimitiveProps<any>> = (props: PrimitiveProps<T>) => JSX.Element
/** Shorthand type */
type unk = unknown
/** Shorthand type */
